...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Vaidehi Vijay" },
      { property: "og:title", content: "Vaidehi Vijay — Full Stack Developer & AI Enthusiast" },
      { property: "og:description", content: "Portfolio of Vaidehi Vijay — Full Stack Developer, Backend Engineer, and AI/Deep Learning enthusiast." },
